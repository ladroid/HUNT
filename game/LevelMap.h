...
int world[WORLD_HEIGHT][WORLD_WIDTH] = {
  ...
  { GRASS, GRASS, GRASS, GRASS, TREES, GRASS, GRASS, GRASS, GRASS, WATER, GRASS, GRASS, STONE, TREES },
  { GRASS, GRASS, GRASS, WATER, STONE, GRASS, GRASS, TREES, GRASS, TREES, GRASS, GRASS, WATER, WATER },
  { GRASS, WATER, WATER, TREES, GRASS, WATER, WATER, STONE, WATER, GRASS, GRASS, GRASS, GRASS, STONE },
  { GRASS, TREES, STONE, TREES, GRASS, WATER, GRASS, TREES, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS },
  { GRASS, TREES, GRASS, STONE, GRASS, GRASS, GRASS, GRASS, GRASS, STONE, GRASS, GRASS, GRASS, GRASS },
  { GRASS, TREES, GRASS, TREES, GRASS, GRASS, GRASS, TREES, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS },
  { GRASS, TREES, STONE, GRASS, GRASS, GRASS, GRASS, STONE, GRASS, GRASS, GRASS, GRASS, GRASS, STONE },
  { GRASS, TREES, GRASS, GRASS, GRASS, GRASS, GRASS, TREES, GRASS, GRASS, GRASS, GRASS, GRASS, WATER },
  { GRASS, TREES, GRASS, TREES, GRASS, GRASS, GRASS, WATER, GRASS, GRASS, GRASS, GRASS, GRASS, TREES },
  { GRASS, TREES, WATER, TREES, GRASS, GRASS, GRASS, TREES, GRASS, GRASS, GRASS, GRASS, GRASS, TREES },
};
